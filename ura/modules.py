...
def localizacao(context, ip, path, custom_path, gender, debug):
...
'''.format(context=context, ip=ip, gender=gender, path=path, custom_path=custom_path, debug=debug, transferencia=transferencia, current_date=current_date)
